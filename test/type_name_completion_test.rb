...
class TypeNameCompletionTest < Minitest::Test
  ...
  def test_prefix_parse
    ...
    Services::TypeNameCompletion::Prefix.parse(buffer("() -> St"), line: 1, column: 7).tap do |prefix|
    ...
    Services::TypeNameCompletion::Prefix.parse(buffer("() -> ::"), line: 1, column: 7).tap do |prefix|
      assert_instance_of Services::TypeNameCompletion::Prefix::NamespacePrefix, prefix
