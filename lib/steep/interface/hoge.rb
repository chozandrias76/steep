{
  ...
  :params => {
    ...
    :clientInfo => { :name => "Visual Studio Code",
                     :version => "1.74.1" },
    :locale => "ja",
    :rootPath => "/Users/soutaro/Developer/steep/sample",
    :rootUri => "file:///Users/soutaro/Developer/steep/sample",
    :capabilities => {
      :workspace => {
        applyEdit: true,
        workspaceEdit: {
    ...
    :trace => "off",
    :workspaceFolders => [{ :uri => "file:///Users/soutaro/Developer/steep/sample",
                            :name => "sample" }] } }
